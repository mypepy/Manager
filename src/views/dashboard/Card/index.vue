<template>
  <div>
    <el-row :gutter="10">
      ...
      <el-col :span="6">
        <el-card>
          <Detail title="访问量" count="52352">
              <template slot="charts">
                 <lineCharts></lineCharts>
              </template>
            <template slot="footer">
              <span>日访问量 42112</span>
            </template>
          </Detail>
        </el-card>
      </el-col>
...
import lineCharts from './Detail/lineChart'
import barCharts from './Detail/barChart'
import progressChart from './Detail/progressChart'
export default {
  name: "Card",
  components: {
    Detail,
